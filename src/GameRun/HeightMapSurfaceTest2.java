...
public class HeightMapSurfaceTest2 {
	...
	public void setUpEntities()	{
		gameEntity golfBall = new GolfBall(new Vector3f(4,20,-455), 3);
   ...
   public static void main(String[] args)	{
	  HeightMapSurfaceTest2 Test = new HeightMapSurfaceTest2();
   }
